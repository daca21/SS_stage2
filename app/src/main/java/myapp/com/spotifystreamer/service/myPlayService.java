package myapp.com.spotifystreamer.service;
...
import myapp.com.spotifystreamer.TrackSelectedActivityFragment;
...
public class myPlayService extends Service implements OnCompletionListener,
    ...
    public static final String BROADCAST_ACTION = " myapp.com.spotifystreamer.seekprogress";

    // Set up broadcast identifier and intent
    public static final String BROADCAST_BUFFER = " myapp.com.spotifystreamer.broadcastbuffer";
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        registerReceiver(broadcastReceiver, new IntentFilter(
                TrackSelectedActivityFragment.BROADCAST_SEEKBAR));
